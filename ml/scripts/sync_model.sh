...
MODEL_SRC="$ML_DIR/output/PacemakerClassifier.mlpackage"
MODEL_DEST="$ML_DIR/models/PacemakerClassifier.mlpackage"
...
if [ ! -e "$MODEL_SRC" ]; then
    ...
    echo "Run 'make export' first to generate the CoreML model"
    exit 1
fi
...
echo "Commit ml/models/PacemakerClassifier.mlpackage to update the app."
